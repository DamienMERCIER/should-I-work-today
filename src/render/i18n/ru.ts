...
export const ru: Strings = {
  ...
  buttons: {
    ...
    going: '🙋 {spot}', notGoing: '✖️ Я больше не еду',
  },
  ...
  profile: {
    ...
    changeHours: 'Часы',
    changeStars: 'Звёзды',
    askStars: 'С какого числа звёзд звать тебя в воду?',
  },
