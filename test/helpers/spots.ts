...
export const MUIZENBERG: Spot = {
  id: 'muizenberg', name: "Muizenberg – Surfer's Corner", region: 'cape-peninsula',
...
export const KOMMETJIE_LONG_BEACH: Spot = {
  id: 'kommetjie-long-beach', name: 'Kommetjie – Long Beach', region: 'cape-peninsula',
...
export const OUTER_KOM: Spot = {
  id: 'outer-kom', name: 'Kommetjie – Outer Kom', region: 'cape-peninsula',
